...
def callProguard():
	command = "java -jar /var/www/html/PE-Droid/proguard5.2.1/lib/proguard.jar -libraryjars lib/android.jar:./lib/aspectjrt.jar:./lib/google-play-services.jar:./output/out/AjcLog.class @proguard.cfg -outjars ./output/output2.jar -ignorewarnings -dontoptimize -dontpreverify -dontshrink -keepattributes *Annotation*"
	os.system(command)
	print 'done proguard'
	
def callProguard2():
	command = "java -jar ~/Downloads/proguard5.2.1/lib/proguard.jar -libraryjars lib/android.jar:./lib/aspectjweaver.jar:./lib/rxjava.jar:./lib/okhttp-2.3.0.jar @proguard.cfg -outjars ./output/output2.jar -ignorewarnings -dontoptimize -dontpreverify -dontshrink -keepattributes *Annotation*"
	os.system(command)
	print 'done proguard'
